...
const VERSION = 'xj-0.24.0';   // 與 src/data/changelog.js 的 APP_VERSION 同步
const SHELL = [
  './', './index.html', './manifest.webmanifest',
  './styles/tokens.css', './styles/base.css', './styles/motion.css',
  './styles/components.css', './styles/views.css',
  './src/app.js', './src/router.js', './src/store.js', './src/ui.js', './src/palette.js', './src/platform.js', './src/install.js', './src/onboarding.js', './src/qrcode.js', './src/starfield.js', './src/tarotdraw.js', './src/orbcast.js', './src/decks.js', './src/sharelink.js', './src/privacy.js', './src/navmenu.js', './src/quickadd.js', './src/share.js', './src/sharecards.js', './src/motion.js', './src/icons.js',
