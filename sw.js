...
const SHELL = [
  ...
  './src/app.js', './src/router.js', './src/store.js', './src/ui.js', './src/palette.js', './src/platform.js', './src/install.js', './src/onboarding.js', './src/qrcode.js', './src/starfield.js', './src/tarotdraw.js', './src/orbcast.js', './src/decks.js', './src/relics.js', './src/llm.js', './src/verify.js', './src/recommend.js', './src/sharelink.js', './src/privacy.js', './src/navmenu.js', './src/quickadd.js', './src/share.js', './src/sharecards.js', './src/motion.js', './src/icons.js',
