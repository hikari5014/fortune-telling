...
const VERSION = 'xj-0.9.0';   // 與 src/data/changelog.js 的 APP_VERSION 同步
const SHELL = [
  ...
  './src/engines/calendar.js', './src/engines/planets.js', './src/engines/astro.js', './src/engines/ziwei.js',
