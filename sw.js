...
const VERSION = 'xj-0.14.0';   // 與 src/data/changelog.js 的 APP_VERSION 同步
const SHELL = [
  './', './index.html', './manifest.webmanifest',
  './styles/tokens.css', './styles/base.css', './styles/motion.css',
  './styles/components.css', './styles/views.css',
  './src/app.js', './src/router.js', './src/store.js', './src/ui.js', './src/palette.js', './src/platform.js', './src/install.js', './src/onboarding.js', './src/qrcode.js', './src/share.js', './src/sharecards.js', './src/motion.js', './src/icons.js',
