...
const VERSION = 'xj-0.18.2';   // 與 src/data/changelog.js 的 APP_VERSION 同步
const SHELL = [
  './', './index.html', './manifest.webmanifest',
  './styles/tokens.css', './styles/base.css', './styles/motion.css',
  './styles/components.css', './styles/views.css',
  './src/app.js', './src/router.js', './src/store.js', './src/ui.js', './src/palette.js', './src/platform.js', './src/install.js', './src/onboarding.js', './src/qrcode.js', './src/starfield.js', './src/tarotdraw.js', './src/sharelink.js', './src/privacy.js', './src/quickadd.js', './src/share.js', './src/sharecards.js', './src/motion.js', './src/icons.js',
  ...
  './src/data/strokes.js', './src/data/kangxi.js', './src/data/lucky81.js', './src/data/magnetic.js', './src/data/changelog.js', './src/data/wenyan.js', './src/data/hexagrams.js', './src/data/tarot.js', './src/data/qian.js', './src/data/cities.js',
  ...
  './src/views/records.js', './src/views/settings.js', './src/views/about.js', './src/views/fortune.js', './src/views/synastry.js', './src/views/hire.js', './src/views/iching.js', './src/views/tarot.js', './src/views/qian.js', './src/views/daily.js', './src/views/direction.js',
