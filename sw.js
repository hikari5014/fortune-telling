...
const VERSION = 'xj-0.4.0';   // 與 src/data/changelog.js 的 APP_VERSION 同步
const SHELL = [
  ...
  './src/engines/naming.js', './src/engines/numbers.js', './src/engines/fortune.js', './src/engines/synastry.js', './src/engines/iching.js', './src/engines/tarot.js', './src/engines/qian.js',
  ...
  './src/views/records.js', './src/views/settings.js', './src/views/about.js', './src/views/fortune.js', './src/views/synastry.js', './src/views/iching.js', './src/views/tarot.js', './src/views/qian.js',
